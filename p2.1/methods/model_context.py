...
from visualize import visualize_tsne_embeddings, visualize_all_tsne_embeddings, visualize_all_tsne_embeddings2,visualize_tsne_embeddings2
...
if __name__ == "__main__":
    ...
    for config in configs:
        ...
        '''visualize_tsne_embeddings(
            ...
            filename=plot_filename[:-4] +"noFitNeg.png" # Guardar la visualización en un archivo
        )
        ...
        visualize_all_tsne_embeddings(
            ...
            filename=plot_filename[:-4] +"noFitNegALL.png"
        )'''
        
        # Definir hiperparámetros de entrenamiento
        batch_size = 64
        epochs = 20  # Puedes aumentar si quieres mejor rendimiento
        ...
        visualize_tsne_embeddings(
            ...
            filename=plot_filename[:-4] +"Neg2.png" # Guardar la visualización en un archivo
        )
        
        visualize_all_tsne_embeddings(
            embeddings=embeddings,  # Array numpy con todos los embeddings
            word_index=word_index,
               # Diccionario {word: idx}
